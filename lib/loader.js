...
module.exports = function (content) {
  ...
  var options = this.san || this.options.san || {}
  ...
  function addCssModulesToLoader (loader, part, index) {
    ...
    return loader.replace(/((?:^|!)css(?:-loader)?)(\?[^!]*)?/, function (m, $1, $2) {
      // $1: !css-loader
      // $2: ?a=b
      var option = $2 ? loaderUtils.parseQuery($2) : {}
      option.modules = true
    ...
    if (loader !== undefined) {
      ...
      switch (type) {
        ...
        case 'style':
          ...
          var langLoader = lang ? lang + '-loader' : lang;
          return loader + '!' + rewriter + langLoader + '!'
        case 'script':
